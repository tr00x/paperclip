...
2. Include @mentions for the intended recipient(s): `@founder_handle`, `@cofounder_handle`, `@cto_handle`.
...
|---|---|---|
| @founder_handle | Co-Founder / Штаб | Pricing decisions, big deals (>$5k MRR), strategy, budget, go/no-go |
| @cofounder_handle | Co-Founder / Клиенты | Client relationships, renewals, churn risk, technical projects |
| @cto_handle | AI / Automation | Agent issues, technical problems, automation requests, system failures |
...
You can READ the group chat. Every heartbeat, check for new messages from @founder_handle, @cofounder_handle, @cto_handle.
