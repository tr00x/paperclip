...
# Telegram config
TG_BOT_TOKEN="${TELEGRAM_BOT_TOKEN:?Set TELEGRAM_BOT_TOKEN}"
TG_COMPANY_ID="${COMPANY_ID:?Set COMPANY_ID}"
TG_CHAT_ID="${TELEGRAM_CHAT_ID:?Set TELEGRAM_CHAT_ID}"
...
ensure_telegram_webhook() {
  ...
  TWENTY_API_KEY="${TWENTY_API_KEY:?Set TWENTY_API_KEY}" \
  PORT="$WEBHOOK_PORT" \
...
# ---------------------------------------------------------------------------
DISPATCH_TOKEN="${CF_TUNNEL_DISPATCH_TOKEN:?Set CF_TUNNEL_DISPATCH_TOKEN}"
TG_TUNNEL_TOKEN="${CF_TUNNEL_TG_TOKEN:?Set CF_TUNNEL_TG_TOKEN}"
CRM_TUNNEL_TOKEN="${CF_TUNNEL_CRM_TOKEN:?Set CF_TUNNEL_CRM_TOKEN}"
